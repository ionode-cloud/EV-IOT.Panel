...
router.delete('/data', vehicleController.deleteVehicleData);    // DELETE — clear device data
...
router.post('/switch', vehicleController.toggleSwitch);          // POST   — toggle ON/OFF
router.put('/switch', vehicleController.setSwitch);              // PUT    — force set state
